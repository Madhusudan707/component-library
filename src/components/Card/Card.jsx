...
const Card = () => {
  return (
    <div className={styles.card_main}>
      ...
      <Snippet code_snippet="https://carbon.now.sh/embed?bg=rgba%28255%2C255%2C255%2C1%29&t=seti&wt=none&l=htmlmixed&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=56px&ph=56px&ln=true&fl=1&fm=Hack&fs=12px&lh=131%25&si=false&es=2x&wm=false&code=%253Cdiv%2520class%253D%27card%27%253E%250A%2520%2520%2520%2520%253Cdiv%2520class%253D%27card-title%27%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Ch4%253ECard%2520Title%253C%252Fh4%253E%250A%2520%2520%2520%2520%253C%252Fdiv%253E%250A%2520%2520%2520%2520%253Cdiv%2520class%253D%27card-img%27%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cimg%2520src%253D%27sample.jpg%27%2520alt%253D%27sample%27%252F%253E%250A%2520%2520%2520%2520%253C%252Fdiv%253E%250A%2520%2520%2520%2520%253Cdiv%2520class%253D%27card-content%27%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cspan%253EMy%2520Card%2520Content%253C%252Fspan%253E%250A%2520%2520%2520%2520%253C%252Fdiv%253E%250A%253C%252Fdiv%253E" />
    </div>
  );
};

    ...
    return (
        <div className={styles.avatar}>
            ...
            <div className={styles.content_block}>
                <img src='https://via.placeholder.com/50' className={`${styles.circle} ${styles.circle_small}`} alt='avatar small'/>
                <img src='https://via.placeholder.com/70' className={`${styles.circle} ${styles.circle_medium}`} alt='avatar medium'/>
                <img src='https://via.placeholder.com/80' className={`${styles.circle} ${styles.circle_large}`} alt='avatar large'/>
            </div>
